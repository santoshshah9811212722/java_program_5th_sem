...
public class Random_Picker {
    public static void main(String[] args){
        ...
        if (num<=list.length){
            ...
            System.out.println("Only 26 students are in your class so please enter below 26");
        }
